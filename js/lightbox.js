...
(function (root, document) {
	...
	(function(root, document) {
		...
		[].forEach.call(document.getElementsByClassName("iframe-lightbox-link"), function(el) {
			el.lightbox = new IframeLightbox(el, {
				...
				onLoaded: function() {
					console.log(document.getElementsByClassName('iframe-lightbox')[0]);
					document.getElementsByClassName('iframe-lightbox')[0].classList.add("site-iframe");
					/* hide your preloader */
				},
				onError: function() {
					/* hide your preloader */
				...
				onClosed: function() {
					setTimeout(() => {
						document.getElementsByClassName('iframe-lightbox')[0].classList.remove("site-iframe");	
					}, 200);
					/* hide your preloader */
				},
				scrolling : true,
	...
	(function(root, document) {
		"use strict";
		[].forEach.call(document.getElementsByClassName("iframe-lightbox-video"), function(el) {
			el.lightbox = new IframeLightbox(el, {
				scrolling: false,
				rate: 500 
			});
